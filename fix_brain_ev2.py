...
if target_start is None:
    ...
    # Old block is 6 lines (through closing paren and if forced_mode:)
    # We do NOT include capture_authorization = CaptureAuthorization( in replacement
    snippet = ''.join(lines[target_start:target_start+6])
    print('OLD 6:', repr(snippet))
    INDENT = '        '
    I2 = '            '
    I3 = '                '
    new_block = [
    ...
    lines[target_start:target_start+6] = new_block
